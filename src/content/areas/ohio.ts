...
export const ohio: StateData = {
  ...
  keywords: [
    ...
    "sell trucking LLC Cleveland",
    "Ohio trucking company buyer",
    "sell owner operator business Ohio",
    "trucking LLC buyer Midwest",
    "sell Amazon Relay LLC Ohio",
    "I-70 trucking company for sale",
    "I-75 trucking LLC sale Ohio",
    "close trucking company Ohio",
  ],
  faqs: [
    {
      q: "Why does Veritor Group specialize in Ohio?",
    ...
    },
    {
      ...
      a: "Location and route history factor into our valuation. LLCs running established lanes on I-70 or I-75 — especially through the Dayton-Columbus-Cincinnati triangle — carry a track record that reduces our risk. That generally translates to a stronger offer than an LLC with thin or unpredictable route data.",
    },
    {
    ...
    },
    {
      ...
      a: "Yes. We evaluate the LLC's MC authority age, insurance status, and FMCSA record — not just recent revenue. Many Ohio carriers formed in 2020–2022 have clean authority that still carries real value even if operations have slowed. Submit your MC/DOT number and we'll give you a written number within 24 hours.",
    },
  ],
  cities: [
    {
      ...
      keywords: [
        ...
        "sell trucking business central Ohio",
        "Amazon Relay carrier buyer Columbus",
        "Rickenbacker freight LLC sale",
        "sell owner operator business Columbus",
        "trucking LLC buyer Columbus Ohio",
        "I-70 trucking company Columbus",
        "I-71 trucking LLC for sale Columbus",
        "close trucking company Columbus Ohio",
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: "When you dissolve, the MC authority expires and any Amazon Relay contract terminates — that value disappears. When you sell the LLC, you transfer the entity, the authority, and the Relay contract in one transaction and receive wire payment for them. For most Columbus carriers with active contracts, selling captures significantly more than dissolution.",
        },
        {
    ...
    },
    {
      ...
      keywords: [
        ...
        "sell trucking business northeast Ohio",
        "Lake Erie freight LLC sale",
        "sell owner operator business Cleveland",
        "trucking LLC buyer Cleveland Ohio",
        "I-90 trucking company Cleveland",
        "Ohio Turnpike trucking LLC sale",
        "close trucking company Cleveland Ohio",
        "Great Lakes carrier LLC buyer",
        "auto parts carrier Cleveland for sale",
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: "Active, documented lanes — especially JIT routes with established customers — are a positive signal in diligence. They show the authority is being used and that the carrier has relationships. We factor operating history into valuation, and active auto parts lanes in northeast Ohio represent a consistent demand base.",
        },
        {
        ...
        },
        {
          ...
          a: "No. We handle everything remotely — document execution is electronic and funds transfer by wire. You close at your own bank in Cleveland, sign from wherever you are, and funds clear the same day. We've never required a seller to travel to our office.",
        },
        {
          q: "My Cleveland LLC has some old violations on its FMCSA record. Is that a dealbreaker?",
          a: "Not automatically. The nature, age, and resolution of violations all matter. A few older violations that are resolved carry much less weight than recent, unresolved ones. Submit your MC/DOT number and we'll evaluate the actual record rather than give you a blanket answer.",
        },
      ],
      nearbySlugs: ["akron", "columbus", "toledo"],
    },
    {
      slug: "cincinnati",
      name: "Cincinnati",
      ...
      keywords: [
        ...
        "sell trucking business southwest Ohio",
        "tri-state trucking LLC sale",
        "sell owner operator business Cincinnati",
        "trucking LLC buyer Cincinnati Ohio",
        "I-71 trucking company Cincinnati",
        "I-75 trucking LLC sale Cincinnati",
        "close trucking company Cincinnati Ohio",
        "Kentucky border carrier LLC buyer",
        "CVG freight carrier for sale",
      ],
      faqs: [
        {
        ...
        {
          q: "Does the Amazon CVG hub factor into what my Cincinnati LLC is worth?",
          a: "If your LLC holds an active Amazon Relay contract running out of CVG or the Hebron, Kentucky fulfillment network, that contract is the most valuable single element of the deal. Relay LLCs close faster and in a tighter price band because the contract itself tells us what we need to know.",
        },
        {
          q: "Where would we close — Ohio or Kentucky?",
          a: "If your LLC is an Ohio entity, we close in Ohio. Sellers choose their own bank — Fifth Third is headquartered in Cincinnati and works seamlessly for same-day wires. If you're operating from a Kentucky entity, we can discuss that structure separately.",
        },
        {
          q: "How far is Dayton from Cincinnati?",
          a: "About 55 miles on I-75 — roughly 45 minutes. Cincinnati is one of our closest markets. We don't require in-person meetings, but if you want to talk face-to-face before committing, we can arrange it without much friction.",
        },
        {
    ...
    },
    {
      ...
      keywords: [
        ...
        "sell trucking business Dayton",
        "I-70 I-75 trucking LLC sale Dayton",
        "sell owner operator business Dayton Ohio",
        "trucking LLC buyer Dayton Ohio",
        "Veritor Group Dayton trucking buyer",
        "close trucking company Dayton Ohio",
        "Montgomery County trucking LLC sale",
        "Dayton freight corridor carrier for sale",
        "local trucking buyer Dayton Ohio",
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: "I-70 and I-75 crossing at Dayton creates one of the most active freight intersections in the Midwest. LLCs with documented operating history on these lanes — particularly carriers running the Columbus-Dayton-Cincinnati or Dayton-Toledo corridors — have traceable route value that we can quantify. It's a real input in our pricing.",
        },
        {
          q: "Can we close in person in Dayton?",
          a: "Yes — and you're one of the few markets where that's genuinely easy because we're in the same city. We can meet at our office on Brownell Rd, or at your branch of Fifth Third or Huntington, whichever is most convenient. Most sellers still prefer fully remote closings, but the option is there for Dayton sellers.",
        },
        {
          q: "I've been running auto parts lanes to Marysville and Anna. Does that route history factor into your offer?",
          a: "Yes. Operating history on established industrial lanes — especially JIT corridors to Honda in Marysville and Anna — signals that the authority is being actively used and that the carrier has a predictable demand base. We pull your FMCSA operating history as part of diligence, and active, consistent routes are a positive input on value.",
        },
        {
          q: "How fast can you actually close on a Dayton LLC?",
          a: "Three days is achievable for a Dayton LLC with clean records. We're local, we know the banks, and we've closed deals here before. The standard range is 3–5 days from the time we receive complete details. If your LLC is in good standing and records are clean, we push for the short end of that window.",
        },
      ],
      nearbySlugs: ["columbus", "cincinnati", "toledo"],
    },
    {
      slug: "toledo",
      name: "Toledo",
      ...
      keywords: [
        ...
        "sell trucking business northwest Ohio",
        "I-75 Toledo trucking LLC sale",
        "sell owner operator business Toledo Ohio",
        "trucking LLC buyer Toledo Ohio",
        "Ohio Turnpike carrier for sale Toledo",
        "close trucking company Toledo Ohio",
        "Michigan border carrier LLC buyer",
        "Lake Erie freight Toledo LLC sale",
        "I-80 I-90 trucking company Toledo",
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: "Active operating history on the Turnpike (I-80/90) is a positive signal. It documents that the authority is being used for real freight and that the carrier can handle long-haul lanes. We look at operating history as one input in valuation — consistent Turnpike activity registers favorably.",
        },
        {
        ...
        },
        {
          ...
          a: "Yes, inactivity alone is not disqualifying. We assess the authority's age, the FMCSA record, and the LLC's legal standing. A Toledo LLC that was active through late 2024 and went quiet recently likely still has marketable authority. Submit your MC/DOT and we'll give you a specific number.",
        },
        {
    ...
    },
    {
      ...
      keywords: [
        ...
        "sell trucking business northeast Ohio",
        "Amazon Relay LLC sale Akron",
        "sell owner operator business Akron Ohio",
        "trucking LLC buyer Akron Ohio",
        "I-76 I-77 trucking company Akron",
        "close trucking company Akron Ohio",
        "Summit County trucking LLC sale",
        "Cleveland metro carrier for sale Akron",
        "northeast Ohio trucking LLC buyer",
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: "Yes. Outstanding loans on equipment are disclosed up front and we work the payoff into the transaction structure. The loan is a line item, not a deal-breaker. We've closed deals with five-figure outstanding balances — the LLC entity transfers cleanly regardless.",
        },
        {
          q: "How fast can you close in Akron?",
          a: "Same as our standard Ohio timeline — 3–5 days from complete details received. Huntington and Fifth Third both process same-day wires in Akron without issue. Clean records and complete paperwork get you to the short end of that window.",
        },
      ],
      nearbySlugs: ["cleveland", "columbus", "dayton"],
    },
