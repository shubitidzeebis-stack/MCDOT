...
export const rhodeIsland: StateData = {
  ...
  keywords: [
    ...
    "sell Amazon Relay LLC Rhode Island",
    "sell owner operator business Rhode Island",
    "trucking LLC buyer New England",
    "I-95 Rhode Island trucking LLC sale",
    "Port of Providence freight LLC buyer",
    "sell trucking LLC Providence RI",
    "Amazon Johnston RI carrier for sale",
    "Quonset Point defense freight LLC sale",
    "close trucking company Rhode Island",
    "sell trucking company Warwick RI",
    "Massachusetts overflow freight carrier RI",
  ],
  faqs: [
    {
    ...
    },
    {
      ...
      a: "Yes. Multi-state authority including Massachusetts is standard for any RI carrier and doesn't complicate the acquisition. Running Providence-to-Boston lanes or Massachusetts-overflow staging is expected operating behavior for a Rhode Island LLC — it's a positive operating history signal.",
    },
  ],
  cities: [
    {
      ...
      keywords: [
        ...
        "Port of Providence freight LLC sale",
        "sell petroleum freight carrier Providence RI",
        "sell Amazon Relay LLC Providence area",
        "trucking LLC buyer Providence Rhode Island",
        "I-95 trucking company Providence RI",
        "close trucking company Providence Rhode Island",
        "sell owner operator business Providence RI",
        "Massachusetts overflow freight LLC Providence",
        "Narragansett Bay carrier for sale Providence RI",
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: "Yes. The I-195 corridor toward southeastern Massachusetts is standard multi-state operating territory for a Providence carrier. Fall River and New Bedford lanes are positive operating history — they show the authority being used on established, documented freight lanes.",
        },
      ],
      nearbySlugs: ["cranston", "warwick", "pawtucket"],
    },
    {
      slug: "cranston",
      name: "Cranston",
      ...
      keywords: [
        ...
        "sell trucking business Cranston RI",
        "Amazon Johnston adjacent LLC sale Cranston",
        "sell owner operator business Cranston RI",
        "trucking LLC buyer Cranston Rhode Island",
        "I-295 trucking LLC sale Cranston RI",
        "close trucking company Cranston Rhode Island",
        "Providence metro freight carrier Cranston RI",
        "I-95 trucking company Cranston Rhode Island",
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: "Yes. We price on MC authority age, FMCSA record, and LLC standing — not the specific RI city. A Cranston LLC with the same profile as a Providence LLC gets the same offer. City boundaries don't factor into our pricing.",
        },
        {
          q: "My Cranston LLC runs both I-95 and I-295. Does running both corridors help?",
          a: "Documented operating history on multiple corridors shows consistent, broad use of the authority — that's a positive signal in diligence. More documented lane activity is better than thin or undocumented history. Dual-corridor history works in your favor.",
        },
        {
        ...
        },
        {
          ...
          a: "Yes. Multi-state authority including Massachusetts is standard for any Cranston carrier. Running regular MA lanes shows the authority is being used consistently across state lines — positive operating history. It doesn't complicate the acquisition.",
        },
      ],
      nearbySlugs: ["providence", "warwick", "pawtucket"],
    },
    {
      slug: "warwick",
      name: "Warwick",
      ...
      keywords: [
        ...
        "TF Green Airport freight LLC sale",
        "sell airport cargo carrier Warwick RI",
        "trucking LLC buyer Warwick Rhode Island",
        "I-95 trucking company Warwick RI",
        "close trucking company Warwick Rhode Island",
        "sell owner operator business Warwick RI",
        "Providence metro freight carrier Warwick",
        "sell trucking LLC Kent County Rhode Island",
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: "Direct I-95 access documents that the LLC is in a position to run Northeast Corridor freight — that's an implicit part of the operating history. I-95 access is a positive context, though the core valuation still rests on the FMCSA record and MC authority age.",
        },
        {
          q: "Can I sell a Warwick LLC that has been running Connecticut lanes?",
          a: "Yes. Connecticut operating authority is standard for any Rhode Island carrier with southbound freight. Running I-95 into CT shows multi-state use of the authority — that's a positive footprint signal in diligence, not a complication.",
        },
        {
        ...
        },
        {
          ...
          a: "A mixed LLC — airport cargo adjacency and active Amazon Relay contract — is a strong operating profile. The Relay contract is the highest-value single component if it's active. The airport cargo history adds documented operating breadth. We price the combination on those fundamentals.",
        },
      ],
    ...
    },
    {
      ...
      keywords: [
        ...
        "sell trucking business Pawtucket RI",
        "Massachusetts border freight LLC sale Pawtucket",
        "sell owner operator business Pawtucket RI",
        "trucking LLC buyer Providence metro northeast",
        "I-95 trucking company Pawtucket RI",
        "close trucking company Pawtucket Rhode Island",
        "Providence Boston corridor LLC sale Pawtucket",
        "Blackstone Valley freight carrier for sale RI",
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: "Yes. Running MA lanes from a Rhode Island LLC shows multi-state use of the authority on established, demand-backed routes. That's a positive footprint signal — it demonstrates the authority is being actively worked on documented lanes.",
        },
        {
          q: "Is Pawtucket treated differently from Providence in your valuation?",
          a: "No. We price on MC authority age, FMCSA record, and LLC standing. A Pawtucket LLC with the same profile as a Providence LLC gets the same offer. The city boundary makes no difference to our pricing.",
        },
        {
          q: "Can I sell a Pawtucket LLC that was formed during the 2021 freight boom and has slowed significantly?",
          a: "A 2021 LLC has seasoned authority — past the key 180-day and one-year thresholds that matter most in our pricing. Lower recent activity doesn't eliminate the value of well-aged, clean authority. Submit your MC/DOT and we'll give you a specific number.",
        },
        {
    ...
    },
    {
      ...
      keywords: [
        ...
        "petroleum terminal freight LLC sale East Providence",
        "sell tanker carrier East Providence RI",
        "trucking LLC buyer Providence harbor Rhode Island",
        "I-195 trucking company East Providence RI",
        "close trucking company East Providence Rhode Island",
        "sell owner operator business East Providence RI",
        "Seekonk River freight corridor carrier sale",
        "Providence metro carrier East Providence for sale",
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: "Positively. Running I-195 east into Fall River and New Bedford shows multi-state authority use on a documented, demand-backed corridor. That operating history is a positive signal in diligence — it extends the LLC's operational footprint and shows the authority is actively worked.",
        },
        {
          q: "How does East Providence compare to Providence proper for valuation?",
          a: "Same process, same criteria. We price on MC authority age, FMCSA record, and LLC standing — not the specific RI city. East Providence carriers get evaluated on the same fundamentals as Providence carriers. The harbor-adjacent context is noted as operating environment, not a valuation modifier.",
        },
        {
          q: "Can I sell an East Providence LLC that's been running steady loads for three years?",
          a: "Three-year-old, actively-used authority is exactly what we value highly. Consistent operating history over multiple years demonstrates that the authority is real, active, and backed by documented freight. That profile commands a strong offer. Submit your MC/DOT and we'll put a number on it within 24 hours.",
        },
        {
