...
export const minnesota: StateData = {
  ...
  keywords: [
    ...
    "trucking company buyer Minnesota",
    "sell Amazon Relay Minnesota",
    ...
    "sell Amazon Relay carrier Minnesota",
    "I-35 trucking company for sale Minnesota",
    "Duluth trucking LLC buyer",
    "Minnesota owner operator exit",
    "sell trucking company Duluth MN",
    "close trucking company Minnesota",
    "sell trucking LLC Rochester MN",
  ],
  faqs: [
    {
    ...
    },
    {
      ...
      a: "Rochester carriers often run specialized freight tied to the Mayo Clinic ecosystem — medical supplies, lab equipment, pharmaceutical cold chain. That specialized demand creates documented lane history that factors positively into valuation. An LLC with a consistent, verifiable route record in Rochester, even on a modest scale, carries more traceable operating value than one with sporadic general freight history.",
    },
  ],
  cities: [
    {
      ...
      keywords: [
        ...
        "sell trucking business Twin Cities",
        "Amazon Relay carrier buyer Minneapolis",
        "I-35W trucking company for sale",
        "I-94 trucking LLC sale Minneapolis",
        "sell owner operator business Minneapolis",
        "close trucking company Minneapolis MN",
        "Target freight carrier LLC sale",
        "Twin Cities trucking LLC buyer",
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: "Operating history on established corridors — especially the I-35W NAFTA lane south or the I-94 east-west lane — signals that your authority is actively used on documented freight routes. That history is a positive input in our valuation. Carriers with verifiable lane data on these interstates typically receive tighter, stronger offers than those with thin or unpredictable route records.",
        },
        {
          q: "Does Minnesota's high income tax burden affect why sellers reach out to you?",
          a: "Directly, yes. Minnesota has one of the highest personal income tax rates in the country, and many Minneapolis LLC owners are factoring that into their exit calculus. A clean sale with a wire-transfer payment closes the chapter in a way that a slow dissolution doesn't. We can't advise on your tax situation, but we can give you a written number fast so you can make a fully informed decision.",
        },
        {
          q: "My Minneapolis LLC has high winter maintenance costs. Does that affect the offer?",
          a: "Cold-weather operating expenses are a known cost structure for Minnesota carriers, and we account for that in how we evaluate maintenance records. Equipment that's been properly maintained through Minnesota winters — with documented service on heaters, fuel systems, and tires — is actually a stronger diligence story than equipment with gaps in the record.",
        },
        {
          q: "How quickly can you close on a Minneapolis LLC?",
          a: "Our standard timeline is 3–5 days from the time we receive complete details. For Minneapolis Relay carriers with an active contract and a clean FMCSA record, we push toward the short end of that range. Wire transfer clears same-day at closing — you choose the bank.",
        },
      ],
      nearbySlugs: ["st-paul", "bloomington", "brooklyn-park"],
    },
    {
      slug: "st-paul",
      name: "St. Paul",
      ...
      keywords: [
        ...
        "sell trucking business east Twin Cities",
        "I-94 trucking LLC sale St. Paul",
        "sell owner operator business St. Paul",
        "trucking LLC buyer St. Paul MN",
        "Mississippi River freight carrier sale",
        "close trucking company St. Paul MN",
        "Ramsey County trucking LLC sale",
        "3M freight carrier St. Paul",
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: "Potentially yes. An LLC formed in 2021 has authority now past the threshold that matters most for value. Six months of inactivity doesn't automatically erase that. Submit your MC/DOT and we'll evaluate the actual FMCSA record and give you an honest number.",
        },
        {
        ...
        },
        {
          ...
          a: "Yes. Documented freight relationships with major corporate shippers like 3M are a positive signal in diligence — they show the authority is actively used on established lanes. That operating history factors into our valuation. Carriers with verifiable corporate freight routes typically receive stronger offers than those with sporadic or undocumented lane histories.",
        },
      ],
      nearbySlugs: ["minneapolis", "bloomington", "brooklyn-park"],
    },
    {
      slug: "rochester",
      name: "Rochester",
      ...
      keywords: [
        ...
        "Mayo Clinic freight carrier for sale",
        "sell trucking business southeast Minnesota",
        "US-52 trucking LLC sale Rochester",
        "sell owner operator business Rochester",
        "trucking LLC buyer Rochester MN",
        "close trucking company Rochester Minnesota",
        "medical freight carrier Rochester sale",
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: "It can be a positive factor. Specialized freight — especially cold chain or medical device logistics — signals a carrier with established customer relationships and documented lane consistency. We look at FMCSA records and authority age the same way for all carriers, but specialized freight history adds a positive operating-history dimension to the diligence picture.",
        },
        {
          q: "I run US-52 between Rochester and the Twin Cities. Is that lane history useful?",
        ...
        },
        {
          ...
          a: "Our standard timeline is 3–5 days from complete details received. Rochester sellers close at US Bank, Wells Fargo, or Bremer Bank — all process same-day wires without issue. Clean records and complete paperwork get you to the short end of that window.",
        },
      ],
      nearbySlugs: ["minneapolis", "st-paul", "bloomington"],
    },
    {
      slug: "duluth",
      name: "Duluth",
      ...
      keywords: [
        ...
        "Port of Duluth freight carrier sale",
        "sell trucking business northern Minnesota",
        "I-35 trucking LLC sale Duluth",
        "sell owner operator business Duluth",
        "trucking LLC buyer Duluth MN",
        "close trucking company Duluth Minnesota",
        "iron range freight carrier Duluth",
        "Lake Superior drayage LLC for sale",
      ],
      faqs: [
        {
          q: "Is operating near the Port of Duluth a fit for a trucking LLC sale?",
        ...
        },
        {
          ...
          a: "Duluth winters — colder and longer than most of Minnesota — are the most cost-intensive operating environment in the state. Higher maintenance costs, fuel additive requirements, and accelerated equipment wear are all disclosed in diligence. We account for them in how we evaluate the operating record. Properly maintained equipment is a stronger diligence story than one with deferred maintenance gaps.",
        },
        {
    ...
    },
    {
      ...
      keywords: [
        ...
        "sell trucking business south Twin Cities",
        "MSP Airport freight carrier sale",
        "Amazon Relay LLC sale Bloomington",
        "I-494 trucking company for sale",
        "sell owner operator business Bloomington",
        "trucking LLC buyer Bloomington MN",
        "close trucking company Bloomington MN",
        "south metro trucking LLC buyer",
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: "Yes. Consistent I-494 activity documents that your authority is actively used on defined Twin Cities metro lanes. We look at FMCSA operating data as part of diligence, and regular beltway activity shows up as a clean, traceable record — a positive input compared to sporadic or undocumented freight history.",
        },
        {
          q: "Can I sell my Bloomington LLC if I still have equipment under lease?",
          a: "Yes. Leased equipment is disclosed up front and structured into the transaction. The lease is a line item, not a dealbreaker. We've closed deals with active equipment financing in place — the LLC entity and MC authority transfer cleanly regardless.",
        },
        {
          q: "How quickly can you close on a Bloomington LLC?",
          a: "3–5 days from complete details received. Bloomington sellers close at US Bank, Wells Fargo, or whatever institution you already use — funds wire same-day at closing. Clean records and a complete package get you to the short end of the range.",
        },
      ],
      nearbySlugs: ["minneapolis", "st-paul", "brooklyn-park"],
    },
    {
      slug: "brooklyn-park",
      name: "Brooklyn Park",
      ...
      keywords: [
        ...
        "sell trucking business north Twin Cities",
        "Amazon Relay LLC sale Brooklyn Park",
        "I-94 trucking company Brooklyn Park MN",
        "sell owner operator business Brooklyn Park",
        "trucking LLC buyer Brooklyn Park MN",
        "close trucking company Brooklyn Park",
        "north metro trucking LLC buyer Minnesota",
        "Medtronic freight carrier north metro sale",
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: "Specialized freight relationships — especially with established north-metro employers like Medtronic — are a positive diligence signal. Documented lane history with a major corporate shipper shows consistent demand and a carrier that has maintained operating standards. We factor that into our pricing.",
        },
        {
          q: "My Brooklyn Park LLC runs I-94 and US-169 lanes. Does that corridor history matter?",
          a: "Yes. Consistent operating history on defined Twin Cities corridors — I-94 east-west and US-169 north toward the St. Cloud area — is visible in your FMCSA record and is a positive pricing input. We pull that data as part of diligence, and regular, traceable activity reads better than sporadic or undocumented operations.",
        },
        {
          q: "I formed my Brooklyn Park LLC in 2022 and haven't run much lately. Is it still worth selling?",
          a: "Possibly yes. An LLC from 2022 has authority approaching the age threshold that matters for value. Even with reduced recent activity, a clean FMCSA record and good LLC standing retain marketable value. Submit your MC/DOT and we'll evaluate the actual record rather than give you a generic answer.",
        },
        {
