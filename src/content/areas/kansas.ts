...
export const kansas: StateData = {
  ...
  faqs: [
    {
      q: "What makes Kansas trucking LLCs different from other Midwest states?",
    ...
    {
      q: "Tornado season creates real equipment risk in Kansas. Can I sell before storm season?",
      a: "Absolutely, and timing matters. Sellers who close before the peak of tornado season avoid the risk of weather-related equipment damage complicating a future sale. If your authority is active now and your insurance is current, we can have a written offer to you within 24 hours and close in 3–5 business days — well ahead of any seasonal pressure.",
    },
    {
      q: "Is Kansas a cost-competitive state to operate a trucking LLC compared to neighboring states?",
      a: "Generally yes. Kansas's overall operating costs — fuel tax structure, registration fees, and compliance overhead — tend to run lower than neighboring states like Illinois or California. For carriers relocating from higher-cost bases or evaluating where to register a new authority, Kansas's cost structure is part of the appeal. For sellers, it means Kansas carriers have often maintained tighter margins than carriers in more expensive markets, which is one reason the exit math makes sense.",
    },
  ],
  cities: [
    {
      ...
      keywords: [
        ...
        "sell aviation freight LLC Wichita",
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: "Documented freight relationships with established industrial customers like Koch's Wichita operations signal consistent utilization and a working operational history. Consistent utilization is one of the strongest inputs to our evaluation. Your DOT record and authority status are still the primary criteria, but that kind of freight context supports the overall picture.",
        },
        {
        ...
        },
        {
          ...
          a: "Your MC number, DOT number, and proof of active insurance are the starting point. We pull your public FMCSA record, review it, and return a written offer within 24 hours. Additional documentation is collected during due diligence after you accept — not before.",
        },
        {
          q: "Does I-70 access from Wichita affect how you evaluate carriers there?",
          a: "Wichita sits on I-135, which connects directly to I-70 to the north. Carriers running I-70 lanes — east toward Kansas City or west toward Colorado — from a Wichita base have documented interstate corridor activity, which is a positive signal. The connection to I-70 is part of the operational context we review.",
        },
      ],
      nearbySlugs: ["overland-park", "topeka", "olathe"],
    },
    {
      slug: "overland-park",
      name: "Overland Park",
      ...
      faqs: [
        {
          q: "Is Overland Park treated as a Kansas City market for Veritor's acquisitions?",
        ...
        {
          q: "How does I-35 through Overland Park affect a carrier's operational profile?",
          a: "I-35 is a primary north-south freight lane connecting Kansas City to Wichita and eventually to Dallas. Carriers running I-35 lanes with documented activity and a clean safety record have an established operational history that supports valuation. Interstate corridor activity is a positive signal regardless of which lane.",
        },
        {
        ...
        },
        {
          ...
          a: "Entirely remote. Documents are signed electronically and funds are wired to your bank. You do not need to meet us in person at any point. We have closed deals with Kansas-side KC sellers without a single in-person meeting.",
        },
      ],
      nearbySlugs: ["olathe", "wichita", "topeka"],
    },
    {
      slug: "kansas-city-ks",
      name: "Kansas City",
      ...
      keywords: [
        ...
        "BNSF corridor carrier sale KCK",
      ],
      faqs: [
        {
          q: "What is the difference between Kansas City KS and Kansas City MO for Veritor's acquisitions?",
        ...
        },
        {
          ...
          a: "Not at all. We specifically target fresh authorities under 180 days old with active insurance. A 45-day authority in good standing is exactly the profile we look for. Active MC, current insurance, clean DOT record — age within that window is not a barrier.",
        },
        {
          q: "Does Veritor close deals on the Kansas side of KC the same way as the Missouri side?",
          a: "The process is identical. Documents are signed electronically, due diligence is conducted remotely, and funds are wired to your bank in 3–5 business days. The state line does not affect the timeline or the closing mechanics.",
        },
      ],
      nearbySlugs: ["overland-park", "olathe", "topeka"],
    },
    {
      slug: "topeka",
      name: "Topeka",
      ...
      faqs: [
        {
          q: "Is Topeka a separate market from the Kansas City metro for Veritor's acquisitions?",
          a: "Yes. Topeka is 65 miles west of KC on I-70 — close enough to access the metro's freight infrastructure but distinct enough to have its own carrier market. Carriers based in Topeka often have operational histories that span the KC corridor to the east and the central Kansas agricultural markets to the west. We evaluate Topeka authorities on their own terms.",
        },
        {
        ...
        },
        {
          ...
          a: "We review the full DOT record in context. A single minor safety event that was addressed and resolved is different from a pattern of violations. Share your MC number and we will tell you exactly where you stand — we would rather have that conversation with you directly than let you wonder.",
        },
        {
          q: "Can I get a written offer from Veritor without committing to sell?",
          a: "Yes. Our written offer is not a binding contract — it is a formal number we put in writing so you can evaluate it on your own timeline. There is no fee and no obligation attached to receiving an offer. You can take it, decline it, or sit on it.",
        },
      ],
      nearbySlugs: ["wichita", "overland-park", "olathe"],
    },
    {
      slug: "olathe",
      name: "Olathe",
      ...
      keywords: [
        ...
        "Johnson County trucking LLC sale",
      ],
      faqs: [
        {
          q: "Is Olathe part of the Kansas City metro for Veritor's acquisition purposes?",
          a: "Yes. Olathe is inside Johnson County, which is the economic core of the Kansas-side KC suburbs. Carriers based in Olathe operate in the same freight ecosystem as Overland Park and the broader KC metro — same intermodal access, same Amazon Relay network, same I-35 and I-70 lane structure.",
        },
        {
        ...
        },
        {
          ...
          a: "I-35 is a primary north-south freight lane — Kansas City to Wichita to Oklahoma City. Carriers with documented I-35 activity have a well-defined lane history that supports valuation. The corridor is active enough that consistent I-35 operation is a meaningful operational signal.",
        },
        {
          q: "My LLC was formed in Olathe but I mainly haul in the Edgerton-Gardner logistics corridor. Does registration address matter?",
          a: "The LLC registration address and the operating territory are separate things. We evaluate the MC authority, DOT safety record, and insurance — not the distance between your address and your primary freight area. The Edgerton-Gardner operating territory is one we understand well.",
        },
        {
    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          a: "It provides context. Carriers based in Lawrence often have operational histories that span both the Topeka market and the KC metro — eastbound toward the intermodal hub, westbound toward central Kansas. Multi-directional lane activity is a positive signal. We evaluate the authority's DOT record for what it reflects, and a Lawrence carrier's record often reflects that breadth.",
        },
        {
          q: "I have served University of Kansas freight needs from my Lawrence base. Is that relevant?",
          a: "Consistent documented utilization is what matters, regardless of the freight source. If your DOT record reflects steady operational activity tied to institutional customers like KU's supply chain, that is a clean, consistent usage pattern — which is exactly what supports a strong offer from us.",
        },
        {
          q: "I want to sell before my insurance renewal in the next 60 days. Is that timeline achievable?",
          a: "Yes. If your authority is currently active and insurance is current, we issue a written offer within 24 hours of receiving your MC and DOT numbers. Closing takes 3–5 business days after acceptance. Sixty days is more than enough runway to close before renewal.",
        },
        {
          q: "Does Veritor handle everything remotely for Lawrence sellers?",
          a: "Entirely. Documents are signed electronically, due diligence is conducted via your public FMCSA record and direct insurance verification, and funds are wired to your bank. No in-person meeting required at any stage of the process.",
        },
      ],
      nearbySlugs: ["topeka", "overland-park", "olathe"],
    },
  ],
};
