...
export const metadata: Metadata = {
  ...
  description: `${SITE.name} is an operator-led US acquirer of logistics LLCs and Amazon Relay carriers. Founded by drivers and owner-operators. 400+ LLCs closed across the United States, average close in 3–5 business days.`,
  keywords: [
    "about Veritor Group",
