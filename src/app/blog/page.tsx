...
export const metadata: Metadata = {
  title: "Insights — Field notes on selling trucking LLCs",
  description:
    "Long-form field notes on selling US logistics LLCs, Amazon Relay acquisitions, MC authority transfers, owner-operator exits, and the trucking M&A market — written for the people who own them.",
  keywords: [
